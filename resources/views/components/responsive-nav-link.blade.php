...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-emerald-600 text-start text-base font-semibold text-emerald-900 bg-emerald-50 focus:outline-none focus:text-emerald-950 focus:bg-emerald-100 focus:border-emerald-700 transition duration-150 ease-in-out'
