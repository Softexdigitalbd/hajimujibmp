...
@section('subheading', __('Update your account information and password.'))
...
<div class="max-w-2xl space-y-6">
    ...
    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div class="border-b border-slate-100 bg-gradient-to-r from-slate-50 to-white px-6 py-4 flex items-center gap-3">
            ...
            <h2 class="text-sm font-bold text-slate-800">{{ __('Account Information') }}</h2>
        </div>
    ...
    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div class="border-b border-slate-100 bg-gradient-to-r from-slate-50 to-white px-6 py-4 flex items-center gap-3">
            ...
            <h2 class="text-sm font-bold text-slate-800">{{ __('Change Password') }}</h2>
        </div>

        <form method="POST" action="{{ route('admin.profile.password') }}" class="p-6 space-y-5">
            @csrf @method('PUT')
            ...
            <div>
                ...
                <input type="password" id="current_password" name="current_password" autocomplete="current-password"
                    class="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-2.5 text-sm text-slate-800 outline-none transition focus:border-indigo-400 focus:bg-white focus:ring-2 focus:ring-indigo-100 @error('current_password', 'updatePassword') border-red-300 bg-red-50 @enderror">
            ...
            <div>
                ...
                <input type="password" id="password" name="password" autocomplete="new-password"
                    class="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-2.5 text-sm text-slate-800 outline-none transition focus:border-indigo-400 focus:bg-white focus:ring-2 focus:ring-indigo-100 @error('password', 'updatePassword') border-red-300 bg-red-50 @enderror">
            ...
            <div>
                ...
                <input type="password" id="password_confirmation" name="password_confirmation" autocomplete="new-password"
                    class="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-2.5 text-sm text-slate-800 outline-none transition focus:border-indigo-400 focus:bg-white focus:ring-2 focus:ring-indigo-100 @error('password_confirmation', 'updatePassword') border-red-300 bg-red-50 @enderror">
