...
@section('content')
    <div class="space-y-16">
        ...
        {{-- Person Image — full width --}}
        <div class="flex flex-col items-center mb-10">
            <img src="{{ asset('img/person.webp') }}" alt="আলহাজ্ব মুজিবুর রহমান চৌধুরী"
                class="w-full h-auto shadow-lg rounded-lg">
        </div>

        {{-- Narrower container for content below image --}}
                ...
                @foreach($features as $feat)
                    <div
                        ...
                        <div class="relative flex flex-col items-center">
                            ...
                            <h3 class="mt-4 text-lg font-extrabold text-[#1b4d3e] noto-bn" lang="bn">{{ $feat['title'] }}</h3>
