...
<body class="admin-shell min-h-full bg-[#f0f2f7] text-slate-800 antialiased">
    <div class="flex min-h-screen">
        ...
        <aside class="w-[260px] shrink-0 flex flex-col bg-gradient-to-b from-[#0f172a] via-[#111827] to-[#0f172a] text-slate-400 shadow-2xl shadow-slate-900/30">
            ...
            <div class="p-5 pb-4">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="block group">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <span class="mt-0.5 block text-[10px] font-semibold uppercase tracking-[0.2em] text-indigo-400/80"><?php echo e(__('Console')); ?></span>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <nav class="p-3 space-y-1 flex-1 overflow-y-auto text-[13px] font-medium mt-1">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-link flex items-center gap-3 rounded-xl px-3 py-2.5 <?php echo e(request()->routeIs('admin.dashboard') ? 'admin-nav-active' : ''); ?>">
                ...
                <?php if(auth()->user()->hasPermission('complaints.index')): ?>
                <a href="<?php echo e(route('admin.complaints.index')); ?>" class="sidebar-link flex items-center gap-3 rounded-xl px-3 py-2.5 <?php echo e(request()->routeIs('admin.complaints.*') ? 'admin-nav-active' : ''); ?>">
                ...
                <?php if(auth()->user()->hasAnyPermission(['settings.behaviour','settings.statuses','settings.transitions','settings.questions','settings.trash'])): ?>
                <p class="px-3 pt-6 pb-2 text-[10px] font-bold uppercase tracking-wider text-slate-600"><?php echo e(__('Settings')); ?></p>

                <?php if(auth()->user()->hasPermission('settings.behaviour')): ?>
                <a href="<?php echo e(route('admin.settings.behaviour.edit')); ?>" class="sidebar-link flex items-center gap-3 rounded-xl px-3 py-2.5 <?php echo e(request()->routeIs('admin.settings.behaviour.*') ? 'admin-nav-active' : ''); ?>">
                    ...
                    <?php echo e(__('Complaint Behaviour')); ?>

                </a>
                <?php endif; ?>
                <?php if(auth()->user()->hasPermission('settings.statuses')): ?>
                <a href="<?php echo e(route('admin.settings.statuses.index')); ?>" class="sidebar-link flex items-center gap-3 rounded-xl px-3 py-2.5 <?php echo e(request()->routeIs('admin.settings.statuses.*') ? 'admin-nav-active' : ''); ?>">
                    ...
                    <?php echo e(__('Complaint Status')); ?>

                </a>
                <?php endif; ?>
                <?php if(auth()->user()->hasPermission('settings.transitions')): ?>
                <a href="<?php echo e(route('admin.settings.transitions.index')); ?>" class="sidebar-link flex items-center gap-3 rounded-xl px-3 py-2.5 <?php echo e(request()->routeIs('admin.settings.transitions.*') ? 'admin-nav-active' : ''); ?>">
                    ...
                    <?php echo e(__('Status Transitions')); ?>

                </a>
                <?php endif; ?>
                <?php if(auth()->user()->hasPermission('settings.questions')): ?>
                <a href="<?php echo e(route('admin.settings.questions.index')); ?>" class="sidebar-link flex items-center gap-3 rounded-xl px-3 py-2.5 <?php echo e(request()->routeIs('admin.settings.questions.*') ? 'admin-nav-active' : ''); ?>">
                    <svg class="w-[18px] h-[18px] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    <?php echo e(__('Form Questions')); ?>
                ...
                <?php if(auth()->user()->hasAnyPermission(['users.view','roles.view'])): ?>
                <p class="px-3 pt-6 pb-2 text-[10px] font-bold uppercase tracking-wider text-slate-600"><?php echo e(__('Access Control')); ?></p>

                <?php if(auth()->user()->hasPermission('users.view')): ?>
                <a href="<?php echo e(route('admin.users.index')); ?>" class="sidebar-link flex items-center gap-3 rounded-xl px-3 py-2.5 <?php echo e(request()->routeIs('admin.users.*') ? 'admin-nav-active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.roles.index')); ?>" class="sidebar-link flex items-center gap-3 rounded-xl px-3 py-2.5 <?php echo e(request()->routeIs('admin.roles.*') ? 'admin-nav-active' : ''); ?>">
                ...
                <?php if(auth()->user()->hasPermission('settings.statuses')): ?>
                <a href="<?php echo e(route('admin.settings.statuses.trash')); ?>" class="sidebar-link flex items-center gap-3 rounded-xl px-3 py-2.5 <?php echo e(request()->routeIs('admin.settings.statuses.trash') ? 'admin-nav-active' : ''); ?>">
                    ...
                    <span class="flex-1"><?php echo e(__('System Trash')); ?></span>
                </a>
                <?php endif; ?>
            </nav>
            ...
            <div class="p-3 text-[13px]">
                ...
                <div class="flex items-center gap-3 px-3 py-2">
                    ...
                    <div class="min-w-0 flex-1">
                        <p class="text-xs font-semibold text-slate-300 truncate"><?php echo e(auth()->user()->name); ?></p>
                        <p class="text-[10px] text-slate-500 truncate">
                            <?php echo e(auth()->user()->is_admin ? __('Super Admin') : (auth()->user()->role?->label ?? __('No role'))); ?>

                        </p>
                    </div>
                </div>
                <a href="<?php echo e(route('admin.profile')); ?>" class="sidebar-link flex items-center gap-2.5 rounded-xl px-3 py-2 mt-1 <?php echo e(request()->routeIs('admin.profile') ? 'admin-nav-active' : 'text-slate-500'); ?>">
                ...
                <a href="<?php echo e(route('home')); ?>" class="sidebar-link flex items-center gap-2.5 rounded-xl px-3 py-2 text-slate-500 mt-1">
        ...
        <div class="flex-1 flex flex-col min-w-0">
            <header class="sticky top-0 z-10 bg-[#f0f2f7]/80 backdrop-blur-xl border-b border-slate-200/60 px-6 lg:px-8 py-5">
                <h1 class="text-xl font-bold tracking-tight text-slate-900"><?php echo $__env->yieldContent('heading'); ?></h1>
                <?php if (! empty(trim($__env->yieldContent('subheading')))): ?>
                    <p class="text-sm text-slate-500 mt-1 max-w-3xl leading-relaxed"><?php echo $__env->yieldContent('subheading'); ?></p>
                <?php endif; ?>
            </header>
...
<?php /**PATH /home/storage/517/4794517/user/htdocs/resources/views/layouts/admin.blade.php ENDPATH**/ ?>