...
<?php $__env->startSection('heading', __('Role Management')); ?>
<?php $__env->startSection('subheading', __('Create roles and configure their permissions to control admin panel access.')); ?>
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2 text-sm text-slate-500">
            <span class="font-semibold text-slate-800"><?php echo e($roles->count()); ?></span> <?php echo e(__('roles defined')); ?>
    ...
    <?php if($roles->isEmpty()): ?>
        <div class="flex flex-col items-center justify-center py-24 rounded-2xl border border-dashed border-slate-200 bg-white text-center">
            ...
            <p class="text-sm font-semibold text-slate-600"><?php echo e(__('No roles yet')); ?></p>
            <p class="mt-1 text-xs text-slate-400"><?php echo e(__('Create your first role to start assigning permissions.')); ?></p>
            <?php if(auth()->user()->hasPermission('roles.create')): ?>
            <a href="<?php echo e(route('admin.roles.create')); ?>"
               class="mt-4 inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-indigo-700">
                <?php echo e(__('Create First Role')); ?>
    ...
    <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        ...
        <div class="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:shadow-md hover:border-indigo-200">
            ...
            <div class="flex items-start justify-between gap-3 mb-4">
                <div>
                    <h3 class="font-bold text-slate-800"><?php echo e($role->label); ?></h3>
                    <code class="text-[11px] text-slate-400 font-mono"><?php echo e($role->name); ?></code>
                </div>
                <div class="flex shrink-0 items-center gap-1">
                    <?php if(auth()->user()->hasPermission('roles.edit')): ?>
                    ...
                    <?php endif; ?>
                    <?php if(auth()->user()->hasPermission('roles.delete')): ?>
                    <form method="POST" action="<?php echo e(route('admin.roles.destroy', $role)); ?>"
                          onsubmit="return confirm('<?php echo e(__('Delete this role? Users with this role will lose access.')); ?>')">
            ...
            <?php if($role->description): ?>
                <p class="text-xs text-slate-500 mb-4 leading-relaxed"><?php echo e($role->description); ?></p>
            <?php endif; ?>
            ...
            <div class="flex items-center gap-4 text-xs text-slate-500">
                <span class="flex items-center gap-1.5">
                    ...
                    <span class="font-semibold text-slate-700"><?php echo e($role->users_count); ?></span> <?php echo e(__('user(s)')); ?>

                </span>
                <span class="flex items-center gap-1.5">
                    <svg class="h-3.5 w-3.5 text-slate-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z"/></svg>
                    <span class="font-semibold text-slate-700"><?php echo e($role->permissions_count); ?></span> <?php echo e(__('permission(s)')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/storage/517/4794517/user/htdocs/resources/views/admin/roles/index.blade.php ENDPATH**/ ?>