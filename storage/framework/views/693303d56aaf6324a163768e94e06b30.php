...
<?php $__env->startSection('heading', __('Dashboard Overview')); ?>
<?php $__env->startSection('subheading', __('Real-time insights and complaint activity metrics.')); ?>
    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-6">
        ...
        <div class="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-xs font-bold uppercase tracking-wider text-slate-400"><?php echo e(__('Total Complaints')); ?></p>
                    <p class="mt-1 text-3xl font-extrabold text-slate-900"><?php echo e(number_format($totalComplaints)); ?></p>
                </div>
            </div>
        ...
        <div class="relative overflow-hidden rounded-2xl border border-violet-200 bg-white p-6 shadow-sm transition-all hover:shadow-md">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-xs font-bold uppercase tracking-wider text-slate-400"><?php echo e(__("Today's Complaints")); ?></p>
                    <p class="mt-1 text-3xl font-extrabold text-slate-900"><?php echo e(number_format($todayTotal)); ?></p>
        ...
        <div class="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-xs font-bold uppercase tracking-wider text-slate-400"><?php echo e(__('Active Complaints')); ?></p>
                    <p class="mt-1 text-3xl font-extrabold text-slate-900"><?php echo e(number_format($activeCount)); ?></p>
                </div>
            </div>
        ...
        <div class="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md">
            <div class="flex items-center gap-4">
                ...
                <div class="w-full">
                    <p class="text-xs font-bold uppercase tracking-wider text-slate-400"><?php echo e(__('Resolution Rate')); ?></p>
                    <div class="flex items-center justify-between mt-1 w-full">
                        <p class="text-3xl font-extrabold text-slate-900"><?php echo e($resolutionRate); ?>%</p>
                        <div class="w-1/2 ml-4">
                            <div class="h-2 w-full rounded-full bg-slate-100 overflow-hidden">
                                <div class="h-full rounded-full bg-emerald-500 transition-all duration-700" style="width: <?php echo e($resolutionRate); ?>%"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-slate-100 bg-gradient-to-r from-slate-50 to-white flex items-center justify-between">
                    <div class="flex items-center gap-2.5">
                        ...
                        <h2 class="text-sm font-bold text-slate-900"><?php echo e(__('Daily Complaints')); ?></h2>
                    </div>
                    <span class="text-xs text-slate-400 font-medium"><?php echo e(__('Last 30 days')); ?></span>
                </div>
                <div class="p-6">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-slate-100 bg-gradient-to-r from-slate-50 to-white flex items-center justify-between">
                    <div class="flex items-center gap-2.5">
                        ...
                        <h2 class="text-sm font-bold text-slate-900"><?php echo e(__('Complaints by Status')); ?></h2>
                    </div>
                </div>
                <div class="p-6">
        ...
        <div class="flex flex-col h-full overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all hover:shadow-md">
            <div class="shrink-0 flex items-center justify-between border-b border-slate-100 bg-gradient-to-r from-slate-50/80 to-white px-5 py-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-sm font-extrabold text-slate-800"><?php echo e(__('Recent Complaints')); ?></h2>
                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest"><?php echo e(__('Feed activity')); ?></p>
                    </div>
                </div>
                ...
                <div class="flex-1 overflow-y-auto p-4 space-y-4 custom-scrollbar">
                    <?php $__empty_1 = true; $__currentLoopData = $recentComplaints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        <a href="<?php echo e(route('admin.complaints.show', $c)); ?>"
                            ...
                            <div class="flex items-center gap-3 mb-3">
                                ...
                                <div class="min-w-0 flex-1">
                                    <h4 class="text-xs font-extrabold text-slate-800 truncate transition-colors"><?php echo e($name); ?></h4>
                                ...
                                <span class="shrink-0 text-[10px] font-bold text-slate-400">
                                    <?php echo e($isToday ? $c->created_at->diffForHumans() : $c->created_at->format('M j')); ?>
                            ...
                            <div class="bg-slate-50/50 rounded-xl p-2.5 mb-3 border border-slate-100/50 transition-all">
                                <p class="text-[12px] font-medium text-slate-600 line-clamp-2 leading-relaxed">
                                    <?php echo e(Str::limit($previewText, 80)); ?>
                            ...
                            <div class="flex items-center justify-between">
                                <span class="inline-flex items-center gap-1.5 rounded-full px-2 py-0.5 text-[10px] font-bold ring-1 ring-inset" style="<?php echo e($sc['badge_style']); ?>">
                                    <span class="h-1.5 w-1.5 rounded-full animate-pulse" style="<?php echo e($sc['dot_style']); ?>"></span>
                                    <?php echo e($c->status->alias_name); ?>

                                </span>
                                <span class="text-[10px] font-bold text-indigo-400 flex items-center gap-0.5 transition-colors">
                                    <?php echo e(__('View Action')); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="flex flex-col items-center justify-center py-16 text-center">
                            ...
                            <p class="text-sm font-semibold text-slate-600"><?php echo e(__('No complaints yet')); ?></p>
                            <p class="mt-1 text-xs text-slate-400"><?php echo e(__('Submitted complaints will appear here.')); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const dailyLabels = <?php echo json_encode($dailyLabels, 15, 512) ?>;
    ...
    const rawData     = <?php echo json_encode($statusCounts, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/storage/517/4794517/user/htdocs/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>